    ...
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        <div class="rating-type border-1px">
          <span class="block positive" :class="{ active: selectRatingType === 2 }" @click="setSelectRatingType(2)">
            全部<span class="count">{{ shopRatings.length }}</span>
          </span>
          <span class="block positive" :class="{ active: selectRatingType === 0 }" @click="setSelectRatingType(0)">
            滿意<span class="count">{{ positiveSize }}</span>
          </span>
          <span class="block negative" :class="{ active: selectRatingType === 1 }" @click="setSelectRatingType(1)">
